...
export const EMAIL_COPY = {
  ...
  subjects: {
    ...
    CASH_DEPOSIT_VERIFIED: 'Cash deposit verified',
    CASH_DEPOSIT_REJECTED: 'Cash deposit rejected',
    RTO_HANDOVER_CONFIRMED: 'Returned parcel received',
  ...
  bodies: {
    ...
    CASH_DEPOSIT_VERIFIED: 'Your cash deposit of ₹{amount} has been verified and reconciled.',
    CASH_DEPOSIT_REJECTED: 'Your cash deposit of ₹{amount} was rejected. Reason: {reason}. Please contact your hub manager.',
    RTO_HANDOVER_CONFIRMED: 'The returned parcel (tracking {trackingNumber}) has been confirmed as received back at your hub.',
