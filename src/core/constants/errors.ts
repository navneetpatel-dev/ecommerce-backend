...
export const ERROR_CODES = {
  ...
  UPLOAD_DRAFT_LIMIT: 'UPLOAD_DRAFT_LIMIT',
  ...
  RETURN_CREDIT_NOTE_AMOUNTS_MISSING: 'RETURN_CREDIT_NOTE_AMOUNTS_MISSING',
...
export const ERROR_MESSAGES = {
  ...
  UPLOAD_CONTENT_MISMATCH: "The file's contents do not match its file type",
  UPLOAD_INVALID_KEY: 'Not an upload key issued by this server',
  UPLOAD_NOT_FOUND: 'Uploaded file was not found',
  UPLOAD_DRAFT_LIMIT: 'Too many new drafts with uploads today — try again tomorrow',
  ...
  RETURN_CREDIT_NOTE_AMOUNTS_MISSING: 'Credit note requires the refund amounts frozen at approval',
